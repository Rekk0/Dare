...
Copyright (c) 2026 Rekko

本项目采用 **[PolyForm Noncommercial License 1.0.0](LICENSE)**。

**这不是 OSI 认可的开源协议，是「源码可见」。** 源码全部公开、可以随便读、
随便改、随便自己部署来玩，但**禁止任何商业用途**。说清楚这一点是为了不误导人：
开源的通行定义不允许限制使用领域，带 NonCommercial 的协议一律不算开源。

能做什么：

- **自己玩、自己部署、改着玩。** 私人娱乐、业余项目、学习研究、实验测试，都行。
- **学校、公益组织、科研机构、政府机构用。** 协议明确把这些算作允许用途，
  哪怕它们的经费来自商业渠道。
- **改，以及发布你改的版本。** 只要仍然限于非商业用途，并且带上这份协议。

不能做什么：

- **任何商业用途。** 拿去收费、拿去给公司内部用、作为收费服务的一部分，都不行。
- 想商用请单独联系我谈授权。版权在我手上，我可以另外给你一份商业许可。

以上是通俗解释，不是法律意见。**以 [LICENSE](LICENSE) 原文为准**，有商业顾虑请找律师。
